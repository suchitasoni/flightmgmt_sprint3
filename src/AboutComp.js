...
class AboutComp extends React.Component{
    ...
    render() {
        ...
        <p> Going inside a specific budget plan isn't just important yet additionally fundamental for you to capitalize on your vacation. 
        ...
        <p> We take off aggressive costs on flight tickets, from probably the most confided companies. We offer you energizing deals to commence your get-away with the goal that it doesn't put an opening in your pocket.
        You can rest guaranteed that you are getting the best flight deal alongside value reserve funds.</p>
        <p> As yet asking why you should book with us? We have a smooth and hassle free reserving procedure that can provide you with astonishing travel deals. 
